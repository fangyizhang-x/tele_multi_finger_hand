...
target_speeds_step_1    = [30, 30, 30, 30]  # Speed 0 : Highest speed. Speed 50 : Low speed
...
target_speeds_step_2    = [30] # Speed 50 : Low speed
...
target_speeds_step_3    = [30, 30, 30, 30, 30] # Speed 10 : very low speed
    ...
    if control.step2_flag is True:
        ...
        for sensor in sensor_list:
            ...
            if sensor.id == 4:
                ...
                abs_val = sensor.abs
            if abs_val > ACCEPTABLE_HIGH : #250
            ...
            elif abs_val < ACCEPTABLE_LOW: #150
        ...
        target_positions_step_9 = [0, 0, 0, 0, 0]                                                          # Minimum position value : open position
        target_speeds_step_9    = [30, 30, 30, 30, 30]                                                      # Speed 10 : very low speed
        message = buildSpeedPosMsg(names_step_9,target_positions_step_9,target_speeds_step_9)
        print(message)
        pub.publish(message)
        time.sleep(1)
        print('***----///----')