  ...
  while cap.isOpened() and not rospy.is_shutdown():
    ...
    # if results.multi_hand_world_landmarks:
        ...
        # for hand_landmarks in results.multi_hand_world_landmarks:
            ...
            thumb_curvature1 = calculate_line_curvature( list_of_landmarks[0:3])
           ...
           # print(len(hand_landmarks.landmark))
            ...
            hand_landmarks_msgs.thumb_curvature = int(thumb_curvature1)
            ...
            # print(">>>>>>>>>  Thumb Radius: ", thum_radius)
            print(">>> thu_adduction:{}, thumb_flex:{}, index:{}, middle:{}, rl:{}".format(int(thumb_curvature1), int(thumb_curvature), int(index_curvature), int(middle_curvature), int((ring_curvature+little_curvature)/2)))
