...
while True:
    #--------------------------------------------------------------
    for i in range(3): # after 3 secs to start the task
        time.sleep(0.5)
    ...
    while handshake_flag: # while loop for handshake
        ...
        if control.start_flag is False:
            ...
            if control.IR_sensor_value < 35:
                ...
                print('>>> Step1: r_th_adduction,r_ix_flexion,r_middle_flexion,r_ring_ltl_flexion---close position')
        ...
        if control.step2_flag is True:
            ...
            handshake_flag = False # control the handshake while loop
            # end of counter while loop
    # end of the while loop for handshake-----------------------------------------------------------------------------------

    # Step 4: open the hand and exit the handshake task
    time.sleep(1)
